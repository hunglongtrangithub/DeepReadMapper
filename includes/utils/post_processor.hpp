...
/// @brief Decode position and strand information from a label. //! Only use for special HNSW index with encoded labels.
/// Ignore if using default sequential labels.
...
/// the candidate sequences are generated during search time.
